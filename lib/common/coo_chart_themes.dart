...
class CooChartThemes {
  ...
  final defaultTheme = CooChartTheme(
    ...
    chartBorderColor: Colors.grey.withValues(alpha: 0.2),
    ...
    columnHighlightColor: Colors.grey.withValues(alpha: 0.2),
  ...
  List<CooChartTheme> getAll() {
    return [
      ...
      CooChartTheme(
        backgroundColor: Colors.white,
        chartBorderColor: Colors.grey.withValues(alpha: 0.3),
        ...
        columnHighlightColor: Colors.grey.withValues(alpha: 0.3),
